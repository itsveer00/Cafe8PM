    ...
    <div className='w-full bg-white py-16 px-4'>
      ...
      <div className='w-[1240px] mx-auto grid md:grid-cols-2'>
        ...
        <div className='flex flex-col justify-center'>
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. At, totam!  Magni reprehenderit quia quibusdam eaque necessitatibus, cumque aliquid dignissimos qui.</p>
